...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 1, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 2, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 3, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 4, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 5, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46');

-- Seed reviews
INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
VALUES
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 5, 'Excellent developer tool!', NOW(), NOW()),
  (2, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 4, 'Great design features', NOW(), NOW()),
  (3, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 5, 'Amazing marketing automation', NOW(), NOW()),
  (4, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 4, 'Very helpful coding assistant', NOW(), NOW()),
  (5, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 5, 'Powerful visualization tool', NOW(), NOW());
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW(), NOW());
...
VALUES
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'These design tips are very helpful', NOW(), NOW()),
  (3, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Marketing automation is crucial', NOW(), NOW()),
  (4, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Launch strategy is on point', NOW(), NOW()),
  (5, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW()),
...
VALUES (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Hello! Interested in collaboration', NOW()),
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Let''s discuss the project details', NOW()),
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'What''s your availability?', NOW()),
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'I can start next week', NOW()),
  (1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('d96ac518-ebae-40eb-b180-fdceb8c6ca46', 1, NULL, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'review', NOW()),
  ('d96ac518-ebae-40eb-b180-fdceb8c6ca46', NULL, 1, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'reply', NOW()),
  ('d96ac518-ebae-40eb-b180-fdceb8c6ca46', NULL, NULL, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'follow', NOW()),
  ('d96ac518-ebae-40eb-b180-fdceb8c6ca46', NULL, 2, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'mention', NOW()),
  ('d96ac518-ebae-40eb-b180-fdceb8c6ca46', 2, NULL, 'd96ac518-ebae-40eb-b180-fdceb8c6ca46', 'review', NOW());
